   ...
   <div class="rdx-bnr-inr overlay-black-middle" style="background-image:url(<?=Yii::$app->urlManager->baseUrl?>/assets/images/background/bg4.jpg);">
            <div class="container">
                <div class="rdx-bnr-inr-entry">
                    <h1 class="text-white">Bo'limlar bo'yich yangliklar</h1>
                </div>
            </div>
        </div>
                             ...
                             <h3 class="post-title">
                              ...
                              <!--   <div class="rdx-post-meta ">
                                ...
                                <div class="rdx-post-readmore"> 
                                    <a href='<?=Yii::$app->urlManager->createUrl(['news/view','id'=>$news->id]);?>' title="READ MORE" rel="bookmark" class="site-button-link">Batafsils<i class="fa fa-angle-double-right">
                                    </i></a> 
                                </div>
