<!--Side bar start -->
    ...
    <img src="/<?=$articl->getImage()?>" width="200" height="143" alt=""> </div>
        ...
        <div class="rdx-post-header">
         <h6 class="post-title"><a href='<?=Yii::$app->urlManager->createUrl(['news/view','id'=>$articl->id]);?>'><?=$articl->title?></a></h6>
           </div>
              ...
              <?php endforeach?>
                            ...
                            <div class="widget widget_categories">
                                ...
                                <ul>
                                    ...
                                    <li><a href="<?=Yii::$app->urlManager->createUrl(['news/category','id'=>$category->id]);?>"><?=$category->title?></a>(<?=$category->getCount();?>)</li>
                                <?php endforeach ?>
                                </ul>
                            </div>
